<template>
  <div class="home">
    ...
    <span class="center"
      >Merci de remplire ce formulaire pour la création d'un article de votre réstaurant
    </span>
    <span class="center"
      >Une image standars sera autaumatiquemment placé en fonction du type d'image selectionner
    </span>
...
export default {
  ...
  data() {
    return {
      ...
      options2: [
        { value: null, text: "Please select an option" },
        { value: "https://images.fradetaxel.fr/plat.png", text: "Image d'un plat" },
        { value: "https://images.fradetaxel.fr/entré.png", text: "Image d'une entrée" },
        { value: "https://images.fradetaxel.fr/accompagnement.png", text: "Image d'un accompagnemment" },
        { value: "https://images.fradetaxel.fr/dessert.png", text: "Image d'un dessert" },
        { value: "https://images.fradetaxel.fr/boisson.png", text: "Image d'une boisson" },
      ],
      show: true,
    };
  },
