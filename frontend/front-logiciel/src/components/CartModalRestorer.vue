<template>
  <div>
        <b-button class="dam" id="show-btn" @click="showModal()">Afficher Menu</b-button>
        ...
        <b-modal ref="cart" hide-footer>
          ...
          <b-button class="mt-3" variant="danger" block @click="deleteOrder()">Supprimer les articles</b-button>
        </b-modal>
      </div>
</template>
